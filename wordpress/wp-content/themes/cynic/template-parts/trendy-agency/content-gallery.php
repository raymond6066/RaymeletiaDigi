    ...
    <div class="<?php echo esc_attr((is_single()) ? 'col-md-7' : 'col-md-12'); ?>">
        <div class="post-info">
            ...
            <a href="<?php echo esc_url(get_day_link(get_the_date('Y'), get_the_date('m'), get_the_date('d'))) ?>"> <i
                        class="ml-tim-35-calander-date-schedule-clock-time-alarm-watch"></i> <?php echo get_the_date('j') ?>
            </a>
        ...
        if ($galleries) {
            ...
            <ul class="clearlist content-slider">
                ...
                foreach ($galleries as $imgid) { ?>
                    <li> <?php echo wp_get_attachment_image((int)$imgid, cynicGetblogThumbnilSize('single')) ?> </li>
                    <?php
                } ?>
            </ul>
            <?php
            ...
            <figure>
                <?php the_post_thumbnail(cynicGetblogThumbnilSize('single'), array('class' => 'img-fluid blog-details-img')) ?>
            </figure>
            <?php
        }
    } else { ?>
