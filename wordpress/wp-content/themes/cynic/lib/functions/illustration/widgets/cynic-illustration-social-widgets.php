    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('facebook')); ?>"
                   ...
                   value="<?php print $instance['facebook']; ?>">
        </p>
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('twitter')); ?>"
                   ...
                   value="<?php print $instance['twitter']; ?>">
        </p>
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('youtube')); ?>"
                   ...
                   value="<?php print $instance['youtube']; ?>">
        </p>
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('googleplus')); ?>"
                   ...
                   value="<?php print $instance['googleplus']; ?>">
        </p>
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('behance')); ?>"
                   ...
                   value="<?php print $instance['behance']; ?>">
        </p>
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('dribbble')); ?>"
                   ...
                   value="<?php print $instance['dribbble']; ?>">
        </p>
