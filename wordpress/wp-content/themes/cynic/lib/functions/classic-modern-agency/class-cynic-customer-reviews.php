    ...
    class CT_TAX_META {
        ...
        public function cynic_add_category_image($taxonomy) {
            ...
            <div class="form-field term-group">
                <label for="category-image-id"><?php _e('Image', 'cynic'); ?></label>
                <input type="hidden" id="category-image-id" name="category-image-id" class="custom_media_url" value="">
                <div id="category-image-wrapper"></div>
                <p>
                    <input type="button" class="button button-secondary ct_tax_media_button" id="ct_tax_media_button" name="ct_tax_media_button" value="<?php _e('Add Image', 'cynic'); ?>" />
                    <input type="button" class="button button-secondary ct_tax_media_remove" id="ct_tax_media_remove" name="ct_tax_media_remove" value="<?php _e('Remove Image', 'cynic'); ?>" />
                </p>
            </div>
            <?php
        }
