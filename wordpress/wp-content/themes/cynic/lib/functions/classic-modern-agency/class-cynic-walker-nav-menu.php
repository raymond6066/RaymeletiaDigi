 ...
 * @see Walker
 */
class Cynic_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        if(isset($cynic_options['cynic_theme_mode']) && $cynic_options['cynic_theme_mode']==2){
            if($args->walker->has_children){
                $atts['class'] = 'dropdown-toggle';
                $atts['data-toggle'] = 'dropdown';
                $atts['role'] = 'button';
                $atts['area-haspopup'] = true;
                $atts['area-expanded'] = false;
                $atts['href'] = '#'; 
            }
        }
