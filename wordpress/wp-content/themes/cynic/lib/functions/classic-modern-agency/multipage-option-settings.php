    ...
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[page_banner_heading_color]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#ffffff', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[page_banner_heading_color]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Inner Page Banner Heading Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[page_banner_heading_color]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_theme_options', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    ...
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[page_banner_text_color]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#ffffff', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[page_banner_text_color]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Inner Page Banner Text Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[page_banner_text_color]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_theme_options', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    ...
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[menu_parent_linkhoverbdrcolor]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#ffffff', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[menu_parent_linkhoverbdrcolor]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Menu Parent Item Underline Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[menu_parent_linkhoverbdrcolor]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_header_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    ...
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[submenu_bg_color]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#ffffff', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[submenu_bg_color]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Submenu Background Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[submenu_bg_color]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_header_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    ...
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[submenu_heading_color]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#444444', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[submenu_heading_color]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Submenu Heading Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[submenu_heading_color]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_header_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    // SubMenu Parent Item Color
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[submenu_linkcolor]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#444444', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[submenu_linkcolor]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Sub-Menu Item Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[submenu_linkcolor]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_header_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    // Menu Parent Item Hover Color
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[submenu_linkhovercolor]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#53b778', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[submenu_linkhovercolor]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Sub-Menu Item Hover Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[submenu_linkhovercolor]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_header_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    ...
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[footer_top_bg_color]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#323a45', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
        'transport' => 'refresh', //What triggers a refresh of the setting? 'refresh' or 'postMessage' (instant)?
        'sanitize_callback' => 'sanitize_hex_color',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[footer_top_bg_color]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Newsletter Background Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[footer_top_bg_color]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
    ...
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[footer_bg_color]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#eaeaea', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
        'transport' => 'refresh', //What triggers a refresh of the setting? 'refresh' or 'postMessage' (instant)?
        'sanitize_callback' => 'sanitize_hex_color',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[footer_bg_color]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Footer Background Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[footer_bg_color]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_footer_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));

    // footer copyright text border color
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[footer_cptborder_color]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#444444', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[footer_cptborder_color]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Footer Copyright Text Border Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[footer_cptborder_color]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_footer_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    ...
    // Newsletter description text color
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[newsletter_heading]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[newsletter_heading]', //Set a unique ID for the control
            array(
        'label' => esc_html__('NewsLetter Heading Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[newsletter_heading]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_footer_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));

    // Newsletter input border color
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[newsletter_input_border]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#ffffff', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[newsletter_input_border]', //Set a unique ID for the control
            array(
        'label' => esc_html__('NewsLetter Input Border Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[newsletter_input_border]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_footer_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            ...
            array(
        'label' => esc_html__('NewsLetter Description Color', 'cynic'), //Admin-visible name of the control
    ...
    //2. Register new settings to the WP database...
    $wp_customize->add_setting('cynic_theme[footer_heading_color]', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
            array(
        'default' => '#444444', //Default setting/value to save
        'type' => 'theme_mod', //Is this an 'option' or a 'theme_mod'?
        'capability' => 'edit_theme_options', //Optional. Special permissions for accessing this setting.
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control(//Instantiate the color control class
            $wp_customize, //Pass the $wp_customize object (required)
            'cynic_theme[footer_heading_color]', //Set a unique ID for the control
            array(
        'label' => esc_html__('Footer Headings Color', 'cynic'), //Admin-visible name of the control
        'settings' => 'cynic_theme[footer_heading_color]', //Which setting to load and manipulate (serialized is okay)
        'priority' => 10, //Determines the order this control appears in for the specified section
        'section' => 'cynic_footer_colors', //ID of the section this control should render in (can be one of yours, or a WordPress default section)
            )
    ));
