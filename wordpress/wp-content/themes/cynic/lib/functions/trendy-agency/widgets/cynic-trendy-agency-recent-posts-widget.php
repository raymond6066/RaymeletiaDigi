...
class cynic_trendy_agency_recent_posts_widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('Seo Agency:Recent Post', 'cynic'), // Name
    ...
    public function widget($args, $instance)
    {
        ...
        ?>
            <?php foreach ($r->posts as $recent_post) : ?>
                ...
                <div class="media">
                    <a class="media-figure" href="<?php the_permalink($recent_post->ID); ?>">
...
{
    register_widget('cynic_trendy_agency_recent_posts_widget');
}
