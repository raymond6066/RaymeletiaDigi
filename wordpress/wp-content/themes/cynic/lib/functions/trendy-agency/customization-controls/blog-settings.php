...
// Social Share
$wp_customize->add_section('blog-social-share-settings',
    array(
        'title' => __('Social Share', 'cynic'), //Visible title of section
        'capability' => 'edit_theme_options', //Capability needed to tweak
        'panel' => 'blog',
    )
);
// Facebook
$wp_customize->add_setting('cynic_blog_social_share_facebook_section',
    array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'skyrocket_switch_sanitization'
...
$wp_customize->add_control(new Skyrocket_Toggle_Switch_Custom_control($wp_customize, 'cynic_blog_social_share_facebook',
    array(
        'label' => __('Show Facebook', 'cynic'),
        'section' => 'blog-social-share-settings',
        'settings' => 'cynic_blog_social_share_facebook_section',
    )
));

// Twitter
$wp_customize->add_setting('cynic_blog_social_share_twitter_section',
    array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'skyrocket_switch_sanitization'
...
$wp_customize->add_control(new Skyrocket_Toggle_Switch_Custom_control($wp_customize, 'cynic_blog_social_share_twitter',
    array(
        'label' => __('Show Twitter', 'cynic'),
        'section' => 'blog-social-share-settings',
        'settings' => 'cynic_blog_social_share_twitter_section',
    )
));

// Google Plus
$wp_customize->add_setting('cynic_blog_social_share_google_plus_section',
    array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'skyrocket_switch_sanitization'
...
$wp_customize->add_control(new Skyrocket_Toggle_Switch_Custom_control($wp_customize, 'cynic_blog_social_share_google_plus',
    array(
        'label' => __('Show Google Plus', 'cynic'),
        'section' => 'blog-social-share-settings',
        'settings' => 'cynic_blog_social_share_google_plus_section',
    )
));

// Linked in
$wp_customize->add_setting('cynic_blog_social_share_linkedin_section',
    array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'skyrocket_switch_sanitization'
...
$wp_customize->add_control(new Skyrocket_Toggle_Switch_Custom_control($wp_customize, 'cynic_blog_social_share_linkedin',
    array(
        'label' => __('Show Linkedin', 'cynic'),
        'section' => 'blog-social-share-settings',
        'settings' => 'cynic_blog_social_share_linkedin_section',
    )
));

// Pinterest
$wp_customize->add_setting('cynic_blog_social_share_pinterest_section',
    array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'skyrocket_switch_sanitization'
...
$wp_customize->add_control(new Skyrocket_Toggle_Switch_Custom_control($wp_customize, 'cynic_blog_social_share_pinterest',
    array(
        'label' => __('Show Pinterest', 'cynic'),
        'section' => 'blog-social-share-settings',
        'settings' => 'cynic_blog_social_share_pinterest_section',
    )
));
