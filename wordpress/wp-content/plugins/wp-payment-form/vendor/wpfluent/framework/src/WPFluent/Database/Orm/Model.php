...
use WPPayForm\Framework\Database\Orm\DateTime;
...
use WPPayForm\Framework\Database\Orm\ModelHelperTrait;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity, UrlRoutable
{
	 ...
	 *
	 * @var \WPPayForm\Framework\Foundation\Dispatcher
	 */
     ...
     *
     * @param  \WPPayForm\Framework\Database\Eloquent\Scope|\Closure|string  $scope
     ...
     *
     * @param  \WPPayForm\Framework\Database\Eloquent\Scope|string  $scope
     * @return bool
     */
     ...
     *
     * @param  \WPPayForm\Framework\Database\Eloquent\Scope|string  $scope
     * @return \WPPayForm\Framework\Database\Eloquent\Scope|\Closure|null
     */
     ...
     * @return $this
     *
     * @throws \WPPayForm\Framework\Database\Eloquent\MassAssignmentException
     */
     ...
     * @param  array  $items
     * @param  string|null  $connection
     * @return \WPPayForm\Framework\Database\Eloquent\Collection
     */
     ...
     *
     * @return \WPPayForm\Framework\Database\Eloquent\Builder
     */
     ...
     * @return \WPPayForm\Framework\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  array|string  $relations
     * @return \WPPayForm\Framework\Database\Eloquent\Builder|static
     */
     ...
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\HasMany
     */
     ...
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  string  $relation
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\BelongsToMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\MorphToMany
     */
     ...
     *
     * @param  \WPPayForm\Framework\Database\Eloquent\Builder  $query
     * @param  array  $options
     * @return bool
     */
     ...
     *
     * @return \WPPayForm\Framework\Database\Orm\DateTime
     */
     ...
     *
     * @param  \WPPayForm\Framework\Database\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @return \WPPayForm\Framework\Database\Eloquent\Relations\Pivot
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'WPPayForm\Framework\Database\Eloquent\Relations\Relation');
        }
     ...
     * @return \WPPayForm\Framework\Database\Eloquent\Model
     */
     ...
     *
     * @return \WPPayForm\Framework\Database\Connection
     */
     ...
     *
     * @return \WPPayForm\Framework\Contracts\Events\Dispatcher
     */
     ...
     *
     * @param  \WPPayForm\Framework\Foundation\Dispatcher  $dispatcher
     * @return void
     */
