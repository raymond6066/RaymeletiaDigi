...
use WPPayForm\Framework\Pagination\Presenter;
use WPPayForm\Framework\Pagination\PaginatorInterface as PaginatorContract;
...
class Paginator extends AbstractPaginator implements ArrayableInterface, ArrayAccess, Countable, IteratorAggregate, JsonSerializable, JsonableInterface, PaginatorContract
{
     ...
     *
     * @param  \WPPayForm\Framework\Pagination\Presenter|null  $presenter
     * @return string
     */
