...
require_once AXILWEB_PLUGIN_PATH . '/lib/illustration/CynicIllustrationPostTypes.php';
require_once AXILWEB_PLUGIN_PATH . '/lib/illustration/cynic-illustration-global-functions.php';
require_once AXILWEB_PLUGIN_PATH . '/lib/illustration/ajax_requests.php';
require_once AXILWEB_PLUGIN_PATH . '/lib/illustration/icons.php';
...
class CynicFeatures
{
    ...
    public function __construct()
    {
        ...
        $this->_post_types = new CynicIllustrationPostTypes();
    ...
    {
        wp_enqueue_script('cynic-plugin-main', self::$url . 'assets/illustration/js/plugin-scripts.js', array('jquery', 'magnific-popup'), CYNIC_FEATURE_PLUGIN_VERSION, true);
        wp_enqueue_style('century_coding_front', self::$url . '/assets/illustration/css/cynic-shortcodes.css', "", CYNIC_FEATURE_PLUGIN_VERSION);
    }
