...
class CynicOnePageServices {

    public function __construct() {
        add_shortcode('cynic_onepage_service', array($this, 'shortcodecb'));
    ...
    public function addMap() {
        if (function_exists('vc_map')) {
            ...
            $menu = (isset($locations[$menu_name]) && !empty($locations[$menu_name])) ? wp_get_nav_menu_object($locations[$menu_name]) : "";
            ...
            $args = array(
                'base' => 'cynic_onepage_service',
                'name' => __('One Page Service Box', 'cynic'),
    ...
    public function shortcodecb($atts = array(), $content = null) {
        ...
        <div class="service-box">
            <div class="box-green-border equalheight"> <?php echo $linkprefix ?><span class="<?php echo esc_attr($iconclass) ?>"></span>
                <div class="service-title"><?php echo esc_html($title) ?></div><?php echo $linksuffix ?>
                <?php echo apply_filters('the_content', $content); ?>
                <?php if (isset($newArr) && !empty($newArr)) { $newArr?>
