...
class CynicCustomCaseStudiesSlider {

    private $paginations = '', $counter = 0, $sliderhtmlid = '';
    private static $overallcounter = 0;

    public function __construct() {
        add_shortcode('cynic_ccs_slider', array($this, 'shortcodecb'));
        add_shortcode('cynic_ccs_slide', array($this, 'shortcodechildcb'));
    ...
    public function addMap() {
        if (function_exists('vc_map')) {
            ...
            $args = array(
                'base' => 'cynic_ccs_slider',
                'name' => __('Case Studies Slider', 'cynic'),
                "category" => __("Cynic Global", "cynic"),
                "as_parent" => array('only' => 'cynic_ccs_slide'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
            ...
            $args = array(
                'base' => 'cynic_ccs_slide',
                'name' => __('Case Study Slide', 'cynic'),
                "category" => __("Cynic Global", "cynic"),
                ...
                'params' => array(
                    ...
                    array(
                        ...
                        'type' => 'textfield',
                        'heading' => __('Slide Small Text', 'cynic'),
                        'value' => '',
                        'admin_label' => false,
                    ),
                    array(
                    ...
                    array(
                        "holder" => "div",
                        "class" => "",
                        'heading' => 'Slider Pagination Logo Image',
                        'type' => 'attach_image',
                        'param_name' => 'pagi_logo',
                        'value' => '',
                    ),
                    array(
                        'type' => 'iconpicker',
    ...
    public function shortcodechildcb($atts = array(), $content = null) {
        ...
        if ($bg_image) {
            ...
            $paginate_logo = wp_get_attachment_image((int) $pagi_logo, array(48, 17), false, array('class' => 'img-responsive'));
        }
        $pagiactiveclass = '';
        if ($this->counter < 1) {
        ...
        <li data-target="#<?php echo esc_attr($this->sliderhtmlid) ?>" data-slide-to="<?php echo self::$overallcounter ?>" data-bg-img="<?php echo isset($paginate_avatar) && $paginate_avatar ? $paginate_avatar : null; ?>" class="<?php echo $pagiactiveclass ?>" >
            <?php echo isset($paginate_logo) && $paginate_logo ? $paginate_logo : null; ?> </li>
        <?php
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="carousel-caption">
                            ...
                            <p class="extra-small-text"><?php echo $small_text ?></p>
...
if (class_exists('WPBakeryShortCodesContainer')) {
    ...
    class WPBakeryShortCode_cynic_Ccs_Slider extends WPBakeryShortCodesContainer {
...
if (class_exists('WPBakeryShortCode')) {
    ...
    class WPBakeryShortCode_cynic_Ccs_Slide extends WPBakeryShortCode {
