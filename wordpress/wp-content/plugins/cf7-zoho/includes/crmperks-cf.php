...
?>
  <div class="vx_div">
        <div class="vx_head">
<div class="crm_head_div"><i class="fa fa-bullhorn"></i> <?php esc_html_e('Marketing Data', 'contact-form-zoho-crm'); ?></div>
...
<p><?php esc_html_e('Need Marketing Insight? ,','contact-form-zoho-crm')?> <a href="<?php echo esc_url($plugin_url) ?>&section=vxc_premium"><?php esc_html_e('Go Pro!','contact-form-zoho-crm')?></a></p>
</div>
 <?php
 }else{
...
if(!$html_added){
   ?> 
   <h3 style="text-align: center;"><?php esc_html_e('No Information Available','contact-form-zoho-crm')?></h3>
   <?php
}
 }
?>
